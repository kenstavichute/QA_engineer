...
Я только начинаю свой путь в тестировании и ниже вы вы найдете мои учебные проекты, отражающие мои навыки и опыт в области тестирования. 
Надеюсь, вы увидите в моих учебных проектах не только навыки, но и интерес к исследованию, поиску оптимальных решений и попытки внести свой вклад в улучшение качества продукта.   
...
5. Дополнить отчет о тестировании Проекта 1
...
__Цель проекта__:   провести тестирования основного сценария использования функционала видеоуроков на образовательной платформе Skyeng - ученик использует только мобильное приложение, преподаватель использует только вэб-приложение
